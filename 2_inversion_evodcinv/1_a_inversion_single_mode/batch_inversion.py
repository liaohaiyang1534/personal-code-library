# -*- encoding: utf-8 -*-
'''
@File        :   batch_inversion.py
@Time        :   2025/01/03 22:41:30
@Author      :   Haiyang Liao
...
def process_directories(directories):
    ...
    script_path = os.path.join(current_directory, "inversion.py")
    ...
    for input_dir in directories:
        ...
        shutil.copy(script_path, os.path.join(output_dir, f"inversion_{timestamp}.py"))

if __name__ == "__main__":
    # List of directories to process
    directories = [
        # Uncomment or add the paths to directories as needed
        ...
        # "/mnt/i/diff_dis_to_cavity/RESULTS_2024-07-02_sgy_20240912_7h_10-17/dispersion_curve_filter test",
        # "/mnt/i/diff_dis_to_cavity/RESULTS_2024-06-29_sgy_60x4-60x6/TEST",
        ...
        "/mnt/i/diff_dis_to_cavity/RESULTS_LHY_20241201_whole_line1_rolling_6_16marray/curve_C3_modified",
    ]
