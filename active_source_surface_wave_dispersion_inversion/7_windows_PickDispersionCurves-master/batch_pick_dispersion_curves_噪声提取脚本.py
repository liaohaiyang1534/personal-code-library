...
for file_path in h5_files:
    try:
        ...
        result = subprocess.run(
            ["python", r"H:\lhyonedrive\OneDrive\code_copy\active_source_classification\7_windows_PickDispersionCurves-master\pick_dispersion_curves_噪声提取脚本.py", file_path, new_directory_path],
            check=True,
            capture_output=True,
            text=True
        )
